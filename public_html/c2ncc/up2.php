    ...
    $files_rows .= <<<HTML
        <tr>
            ...
            <td>
                ...
                <a id="name_$i" href="https://commons.wikimedia.org/wiki/$file_to_html" target="_blank">$file</a>
            </td>
            <td>
                <div id="$i">
            ...
            <td>
                ...
                <div id="new_$i" style="display: none;">
                    <a href="https://nccommons.org/wiki/$file_to_html" target="_blank"><i class="fa fa-thumbs-up"></i> New file</a>
                </div>
            </td>
        </tr>
HTML;
